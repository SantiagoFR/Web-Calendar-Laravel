        ...
        <div class="col-sm-8">
            <div id="carouselExampleControls" class="carousel vert slide" data-ride="carousel" data-interval="2700">
                <ol class="carousel-indicators">
                    ...
                    <li data-target="#carouselExampleIndicators" data-slide-to="{{ $evento->id }}" class="active"></li>
                    @else
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <p><strong>Desde: </strong> {{ $evento->start }} <strong>Hasta: </strong>{{ $evento->end }}</p>
                        ...
                        <p><strong>{{ $evento->title }}</strong></p>
                        <p><strong>{!! $evento->description !!}</strong></p>
                        <p><strong>Desde: </strong> {{ $evento->dtstart }} <strong>Hasta: </strong>{{ $evento->end }}
                        </p>
                        @isset($evento->etiqueta)
                        <p><strong>Etiqueta: </strong>{{ $evento->etiqueta->name }}</p>
                        @endisset
